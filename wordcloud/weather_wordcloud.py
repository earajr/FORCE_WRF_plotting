...
wordcloud = WordCloud(width=1500, mask = mask,stopwords=stopwords,height=909,max_font_size=200,max_words=50,collocations=False,background_color='black').generate(string)
